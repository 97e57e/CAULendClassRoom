...
urlpatterns = [
    ...
    path('reservation-cancel/<int:reservation_id>' , views.reservation_cancel, name='reservation_cancel'),
    path('reservation/<int:reservation_id>' , views.reservation_modify, name='reservation_modify'),
